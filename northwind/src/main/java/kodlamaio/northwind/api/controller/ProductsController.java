...
@RestController //yani sana adroid de ios da ulaşabilir
@RequestMapping("/api/products")
public class ProductsController {

    private ProductService productService;

    @Autowired //productservice ı ortama enjekte etmiş olduk.Productmanagerı da çünkü onu iplements ediyor
